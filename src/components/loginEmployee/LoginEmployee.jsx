  ...
  return (
    <>
      <div className="w-full h-dvh flex items-center bg-background overflow-hidden fixed -z-20">
        ...
        <div className="w-full h-dvh flex items-center justify-center lg:justify-end z-10">
          <div className="w-[80%] h-[80%] md:h-[70%] flex flex-col justify-center items-center box-shadow-card bg-surface rounded-2xl p-4 md:p-16">
            ...
            <div className="my-10 w-full">
              ...
              <h5 className="font-bold text-text-second text-lg">Empleado</h5>
            </div>
            <form action="" className="flex flex-col items-center w-full">
              <input
                className="w-full p-4 border-2 border-border rounded-lg placeholder:font-bold placeholder:text-lg mb-6"
                placeholder="Email"
                type="email"
                name=""
                id=""
              />
              <input
                className="w-full p-4 border-2 border-border rounded-lg placeholder:font-bold placeholder:text-lg"
        ...
        <div className="hidden lg:visible w-full h-dvh lg:flex lg:items-end items-center justify-center z-10 mb-16">
            <img
              className="h-[75%] before-login"
              src="/src/assets/images/doctorEmployeeLogin.webp"
              alt=""
            />
        </div>
